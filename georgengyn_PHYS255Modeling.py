...
# Range
range = r0.x + v0 * cos(radians(theta0)) * t
print("Range is " + round(range,2))

# Final Velocity 
vF = vector(cos(radians(theta0)) * v0, sin(radians(theta0)) * v0  + -g * t, 0)
...
# Maximum Elevation
tMax = v0 * sin(radians(theta0)) / 9.8
maxHeight = 3 + 10 * sin(radians(theta0)) * tMax + .5 * -g * tMax**2
print("Max height is " + round(maxHeight, 2))